...
public class HeapFile {
	...
	*/
	...
	/*
	 * methode pour rajouter une page de données et retourner le PageId de cette page
	...
	* @throws IOException
	...
	/*
	 * methode qui sert à retourner le PageId d’une page de données sur laquelle il reste des cases libres
	 * @return PageId un pageId
     * @throws IOException
	 */
	...
	/*
	 *  methode qui écrit l’enregistrement record dans la page de données identifiée par pageId, et renvoyer son Rid
	...
	/*
	 * methode qui doit retourner la liste des records stockés dans la page identifiée par pageId.
	 * @param pageId un PageId 
	...
	/*
	 * methode qui sert a inserer des record 
	 * @param record un Record
	 * @return un Rid 
	 * @throws IOException
	 */
	...
	/*
	 * methode pour recuperer tour les record d'une relation
	 * @return liste de record
	 * @throws IOException
	 */
